...
public class DoubleShip extends LinearLayout implements IShip {

    Context context;
    LinearLayout ship;

    public DoubleShip(Context context) {
        super(context);
        this.context = context;
    }

    public DoubleShip(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public DoubleShip(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
    }

    public DoubleShip(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
